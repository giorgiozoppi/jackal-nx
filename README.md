...
jackal-nx is a free, open-source, high performance XMPP server which aims to be known for its stability, simple configuration and low resource consumption based on jackal implementation.

## Features

jackal-nx supports the following features:
...
```bash
$ git clone git@github.com:giorgiozoppi/jackal-nx.git
$ cd jackal-nx
...
Giorgio Zoppi, <giorgio.zoppi@yenflow.com>